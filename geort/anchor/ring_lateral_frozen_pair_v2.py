"""Corrected frozen-robot Ring lateral pair writer."""
...
def main(argv=None):
    ...
    frames = human["human_frames"][mask_h]
    context = interpolate_sparse_trajectory(frames[:, (4, 8, 12, 16, 20), :].reshape(5, -1), 50)["points"].reshape(50, 5, 3)
